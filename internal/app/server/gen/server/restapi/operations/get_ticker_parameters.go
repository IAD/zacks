...
//
// To ensure default values, the struct must have been initialized with NewGetTickerParams() beforehand.
...
func (o *GetTickerParams) bindTicker(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
